...
def main(unused_argv):
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session(config=tf.ConfigProto(
      ...
      server.init_aggregation(model, FLAGS.dpsgd, FLAGS.projection, FLAGS.proj_dims, FLAGS.lanczos_iter, FLAGS.wei_avg)
      ...
      for r in range(COMM_ROUND):
        ...
        participating_clients = server.sample_clients(FLAGS.N, client_set, FLAGS.client_batch_size, \
