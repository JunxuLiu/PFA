...
def placeholder_inputs(batch_size, IMAGE_PIXELS):
...
def mnist_model(FLAGS, eps_list=None, noise_multiplier=None):
    ...
    data_placeholder, labels_placeholder = placeholder_inputs(FLAGS.client_batch_size, img_pixels)
    ...
    elif FLAGS.model == 'cnn' and (FLAGS.dataset == 'mnist' or FLAGS.dataset == 'mnist'):
    ...
    if FLAGS.lr_mode == 'decay':
      learning_rate = tf.train.exponential_decay(learning_rate=FLAGS.lr, global_step=global_step,
