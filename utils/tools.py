...
def save_progress(FLAGS, model, Accuracy_accountant, Budgets_accountant=None):
    ...
    filename = "{}{}{}{}".format( FLAGS.N, ('-fedavg' if FLAGS.fedavg else ''), ('-wavg' if FLAGS.weiavg else ''), ('-pro{}_{}'.format(FLAGS.proj_dims, FLAGS.lanczos_iter) if FLAGS.projection else ''))
