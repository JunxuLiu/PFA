...
from myopacus.accountants.pdp_utils import PrivCostEstimator
...
# ===================
    ...
    def prepare_cpdpfl(
        ...
        for acct, target_epsilon in zip(self.accountant.accountants, target_epsilons):
            assert acct.mechanism() == "fed_rdp", "The accountant must be `fed_rdp`."
            noise_multiplier = get_noise_multiplier(
                target_epsilon=target_epsilon,
                target_delta=target_delta,
                sample_rate=sample_rate,
            ...
            acct.init(noise_multiplier = noise_multiplier,
                sample_rate = sample_rate, 
                client_rate = client_rate,
                steps = num_steps,
                rounds = num_rounds)
