...
# lr
#python main.py --max_steps 10000 --dataset mnist --model cnn --lr 0.2 --N 10 --num_microbatches 4 --client_batch_size 4 --sample_mode R --sample_ratio 0.8 --local_steps 100 --dpsgd True --eps mixgauss1 --projection True --proj_dims 1 --lanczos_iter 256 --version 2

########## Pfizer ###########

#for ((i=20; i<=20; i=i+20)); do {
