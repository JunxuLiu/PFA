...
#for learning_rate in 0.005 0.01 0.05 0.1 0.15; do {
for learning_rate in 0.05; do {
...
# cnn-noniid-nodp
log_dir='log_final/log_'$vid'/'${dataset}'/cnn/noniid'${noniid_level}'/nodp'
...
# cnn-iid-nodp
log_dir='log_final/log_'$vid'/'${dataset}'/cnn/iid/nodp'
